  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="images/admin.ico"  alt="" data-src="images/admin.ico" data-src-retina="images/admin.ico" width="60" height="69" /> </div>
        <div class="user-info">
    ...
    <ul>	
      ...
      <li><a href="user-access-log.php"><span class="fa fa-users"></span>&nbsp;&nbsp;Invite User</a></li>
    </ul>